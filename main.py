...
HELP_TEXT = f"Чтобы внести новую задачу, введите '/{NEW_TASK}', затем введите дату в формате " \
            "ДД.ММ.ГГГГ, затем введите формулировку задачи.\n" \
            ...
            "затем дату в формате ДД.ММ.ГГГГ, затем изначальную формулировку задачи.\n" \
            "Пример ввода: /1 16.12.2022 Текст задачи"
DATE_FORMAT = "%d.%m.%Y"
